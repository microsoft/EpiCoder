...
def run_test_files(base_dir, output_jsonl, analysis_file, max_execution_time=10, begin_idx=0, end_idx=99999, begin_iter=1, max_iter=3, rewrite=False, instruction_field="instruction"):
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=5) as executor:
        ...
        for future in concurrent.futures.as_completed(futures):
            future.result()  # 这里是为了确保所有任务的异常被捕获和处理
...
def main():
    ...
    output_jsonl = f'output/gen_code/TheStack_V2/Python_clustered_150k/p7_function_f1_c33_dep_t10_2/test_results_debug_{begin_idx}_{end_idx}.jsonl'
    code_generation_file = 'output/gen_code/TheStack_V2/Python_clustered_150k/p7_function_f1_c33_dep_t10_2/code_0_50000.jsonl'
    

    run_test_files(base_dir, output_jsonl, code_generation_file,begin_idx=begin_idx,end_idx=end_idx,begin_iter=1,max_iter=3,rewrite=False,instruction_field=instruction_field)
